...
- Upload my Java and PHP CRUD projects to GitHub.
- Build a contact manager or library system with a database.
- Create a simple project using files + database.
- Develop a clear and organized portfolio.
- Deploy a basic web project (HTML/CSS + PHP/MySQL).
